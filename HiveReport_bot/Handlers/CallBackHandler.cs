...
public class CallbackHandler
{
    ...
    public async Task HandleCallbackAsync(ITelegramBotClient botClient, CallbackQuery callbackQuery)
    {
        ...
        {
            case "call_team":
                _userStateService.SetUserState(chatId, true);
            ...
            case "NBU_mod":
                await botClient.SendTextMessageAsync(
                    chatId,
                    "Модуль для небанківських фінустанов, з усіма комплектами бланків, що звітуються до НБУ в електронному вигляді <i>З 1 липня 2020 року НФУ — небанківські фінансові установи мають звітувати до НБУ виключно у електронному вигляді, відповідно до вимог Закону України «Про внесення змін до деяких законодавчих актів України, щодо удосконалення функцій із державного регулювання ринків фінансових послуг» від 12.09.2019 р. № 79-ІХ (Закон про «спліт»)</i>",
